...
import { SOFA12_ADMIN_GROUPS } from './sofa12-admin-data';
...
SOFA12_ADMIN_GROUPS.forEach((group) => {
...
export function useSofa12AdminRows(groupSlug: string, moduleSlug: string) {
