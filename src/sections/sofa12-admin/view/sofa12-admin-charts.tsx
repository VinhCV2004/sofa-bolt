...
import {
  ...
  SOFA12_ADMIN_TOP_PRODUCTS,
  SOFA12_ADMIN_ORDER_SERIES,
  SOFA12_ADMIN_CHANNEL_CHART,
  SOFA12_ADMIN_REVENUE_SERIES,
} from '../sofa12-admin-data';

// ----------------------------------------------------------------------

const PALETTE = ['#E07A4F', '#5B7553', '#A6634A', '#8BA888', '#3D2817'];

export function Sofa12AdminCharts() {
  ...
  const channelOptions = useChart({
    colors: PALETTE,
    labels: SOFA12_ADMIN_CHANNEL_CHART.labels,
    stroke: { width: 0 },
  ...
  const topProductOptions = useChart({
    colors: [PALETTE[1]],
    xaxis: { categories: SOFA12_ADMIN_TOP_PRODUCTS.labels },
    ...
    <Grid container spacing={3}>
      <Grid xs={12} md={8}>
        <Card>
          ...
          <Chart
            type="line"
            series={SOFA12_ADMIN_REVENUE_SERIES}
      ...
      <Grid xs={12} md={4}>
        <Card sx={{ height: 1 }}>
          ...
          <Chart
            type="donut"
            series={SOFA12_ADMIN_CHANNEL_CHART.series}
      ...
      <Grid xs={12} md={6}>
        <Card>
          ...
          <Chart
            type="bar"
            series={SOFA12_ADMIN_ORDER_SERIES}
      ...
      <Grid xs={12} md={6}>
        <Card>
          ...
          <Chart
            type="bar"
            series={[{ name: 'Đã bán', data: SOFA12_ADMIN_TOP_PRODUCTS.series }]}
