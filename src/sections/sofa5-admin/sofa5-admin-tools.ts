...
export const SOFA5_ADMIN_TOOLS: Sofa5AdminTool[] = [
  {
    slug: 'reports',
...
export const findSofa5AdminTool = (slug?: string) =>
  SOFA5_ADMIN_TOOLS.find((tool) => tool.slug === slug);

// ----------------------------------------------------------------------

export type Sofa5FunnelStep = {
  label: string;
  value: number;
  icon: string;
  desc: string;
...
export const SOFA5_ADMIN_FUNNEL: Sofa5FunnelStep[] = [
  {
    label: 'Lượt truy cập',
    value: 128400,
...
export const SOFA5_SETTINGS_FIELDS = [
...
export const SOFA5_SETTINGS_TOGGLES = [
...
export const SOFA5_NOTIFICATIONS = [
