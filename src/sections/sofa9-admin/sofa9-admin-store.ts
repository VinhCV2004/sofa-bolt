...
import { SOFA9_ADMIN_GROUPS, type Sofa9AdminRow } from './sofa9-admin-data';

export type AdminRow = Sofa9AdminRow;
...
SOFA9_ADMIN_GROUPS.forEach((group) => {
...
export function useSofa9AdminRows(groupSlug: string, moduleSlug: string) {
